...
#define PINS_COUNT (102u)       //(79u)  20250318
#define NUM_DIGITAL_PINS (102u) //(66u)  20250318
...
#define BOARD_PIN_TO_SPI_PIN(x) \
  (x == BOARD_SPI_SS0 ? PIN_SPI_SS0 : (x == BOARD_SPI_SS1 ? PIN_SPI_SS1 : (x == BOARD_SPI_SS2 ? PIN_SPI_SS2 : PIN_SPI_SS3)))
#define BOARD_PIN_TO_SPI_CHANNEL(x) \
  (x == BOARD_SPI_SS0 ? 0 : (x == BOARD_SPI_SS1 ? 1 : (x == BOARD_SPI_SS2 ? 2 : 3)))
